...
public class CustomerService {
	...
	public GoGasResponse changePassword(CredentialsDTO credentialsDTO, boolean isReset) {
		...
		Customer customer = Optional
				.ofNullable(customerRepository.findByPhone(Long.parseLong(credentialsDTO.getPhone())))
				.orElseThrow(() -> new ResponseStatusException(HttpStatus.BAD_REQUEST,
		...
		if (isReset) {
			...
			SMSUtil.sendSMS(customer.getPhone(), "GoGas - Reset Login Password : " + generatedPwd);
	...
	public Customer findCustomerByPhone(String name) {
		return Optional.ofNullable(customerRepository.findByPhone(Long.parseLong(name)))
